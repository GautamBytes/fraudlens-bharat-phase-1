...
| TC-031 | Hardened container boundary | Build and inspect the production image | Pinned base and hashed runtime dependencies install; process is UID 10001; pytest is absent; English/Hindi OCR is present | Automated |
