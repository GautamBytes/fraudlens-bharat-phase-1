...
RULE_KEYWORDS: Dict[str, tuple[str, ...]] = {
    ...
    "investment_scam": ("investment", "crypto", "trading", "double", "guaranteed", "profit", "vip", "2x return"),
    "loan_scam": ("loan", "processing fee", "cibil", "disbursal", "recovery", "instant approval", "file charge", "insurance fee"),
    "courier_scam": (
        "parcel no",
        "courier",
        "fedex",
